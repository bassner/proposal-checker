        ...
        {state.status === "idle" && (
          <div className="space-y-3">
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-medium text-white/50">Link expires after</label>
              <Select value={expiration} onValueChange={setExpiration}>
                <SelectTrigger className="h-8 w-full border-white/10 bg-white/5 text-sm text-white/80">
                  <SelectValue />
                </SelectTrigger>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <Lock className="absolute left-2.5 top-1/2 h-3.5 w-3.5 -translate-y-1/2 text-white/30" />
                <input
                  type="password"
                  value={password}
                  onChange={(e) => setPassword(e.target.value)}
                  placeholder="Leave empty for no password"
                  className="h-8 w-full rounded-md border border-white/10 bg-white/5 pl-8 pr-3 text-sm text-white/80 placeholder:text-white/25 focus:border-white/20 focus:outline-none focus:ring-1 focus:ring-white/10"
                />
              </div>
            </div>
