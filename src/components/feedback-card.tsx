                ...
                <span className="font-medium text-slate-600 dark:text-white/45">
                  {loc.page != null && onPageClick ? (
                    <button
                      ...
                      className="text-blue-500/70 hover:text-blue-600 dark:text-blue-400/70 dark:hover:text-blue-300 underline decoration-blue-400/30 hover:decoration-blue-500/50 dark:hover:decoration-blue-300/50 transition-colors"
