        ...
        <div className={`flex gap-4 ${pdfOpen ? "flex-col lg:flex-row" : ""}`}>
          ...
          {pdfOpen && (
            <aside
              ...
              className="no-print sticky top-4 h-[calc(100vh-2rem)] w-full shrink-0 overflow-hidden rounded-xl border border-white/10 bg-white/5 backdrop-blur-xl lg:w-[400px]"
            >
              <PdfViewer
                reviewId={reviewId}
