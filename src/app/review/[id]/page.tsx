          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h1 className="text-lg font-semibold text-slate-900 dark:text-white">Review Results</h1>
                {reviewMode === "thesis" && (
...
function StatusCard({ variant, title, message, buttonLabel = "Review Another", children }: {
  ...
  const styles = {
    ...
    neutral: "border-slate-200 bg-white text-slate-600 dark:border-white/10 dark:bg-white/5 dark:text-white/60",
  };
  const msgStyles = {
