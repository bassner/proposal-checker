  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-slate-50 dark:bg-gradient-to-br dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      ...
      <div className="relative flex w-full max-w-md flex-col items-center px-6 py-12">
        ...
        <footer className="mt-12 text-center text-xs text-slate-300 dark:text-white/20">
          Created with ❤️ by{" "}
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-slate-50 dark:bg-gradient-to-br dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      ...
      <div className="relative w-full max-w-md px-6">
        <div className="rounded-2xl border border-red-200 bg-red-50 p-8 backdrop-blur-xl dark:border-red-500/20 dark:bg-red-500/5">
  ...
  return (
    <div className="relative min-h-screen bg-slate-50 dark:bg-gradient-to-br dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      ...
      <div className="relative mx-auto min-h-screen w-full max-w-[960px] px-3 py-4 sm:px-6 sm:py-8">
        ...
        <div className="space-y-5 rounded-2xl border border-slate-200 bg-white p-3 shadow-sm dark:border-white/10 dark:bg-white/5 dark:shadow-none dark:backdrop-blur-xl sm:p-5">
          <FileDropzone
                  ...
                  {modeGroups.map((g) => {
                    ...
                    return (
                      <label
                        ...
                        } ${isUploading ? "pointer-events-none opacity-40" : "hover:bg-slate-100 dark:hover:bg-white/[0.06]"}`}
                      >
          ...
          {noneSelected && (
            <p className="text-sm text-amber-600 dark:text-amber-400">Select at least one check group to start a review.</p>
          )}
        ...
        <footer className="mt-12 pb-4 text-center text-xs text-slate-300 dark:text-white/20">
          Created with ❤️ by{" "}
          <a href="https://github.com/bassner" target="_blank" rel="noopener noreferrer" className="text-slate-400 transition-colors hover:text-slate-600 dark:text-white/30 dark:hover:text-white/50">
            @bassner
          </a>
